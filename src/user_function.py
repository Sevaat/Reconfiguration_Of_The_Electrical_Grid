...
def get_fitness(genotype: List[str]) -> float:
    ...
    for branch in nm.branches:
        if branch.start == "4" and branch.end == "5" and genotype[0] == "0":
            continue
        elif branch.start == "5" and branch.end == "6" and genotype[1] == "0":
            continue
        elif branch.start == "2" and branch.end == "5" and genotype[2] == "0":
            continue
        elif branch.start == "3" and branch.end == "6" and genotype[3] == "0":
            continue
        else:
